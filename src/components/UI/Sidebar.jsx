        ...
        <div className="mt-5 flex-1 overflow-y-auto">
          <nav className="px-2 space-y-1">
            ...
            <div className="mt-4">
              ...
              >
                <FaGraduationCap className="mr-3 flex-shrink-0 h-6 w-6 text-indigo-300" />
                <span className="flex-1 text-left">Admissions</span>
                <svg
                  className={`ml-3 h-5 w-5 transform ${expandedSections.admissions ? 'rotate-90' : ''}`}
            ...
            <div className="mt-1">
              <button
                ...
                className="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-indigo-100 hover:bg-indigo-700 hover:text-white w-full"
              >
                <FaBookOpen className="mr-3 flex-shrink-0 h-6 w-6 text-indigo-300" />
                <span className="flex-1 text-left">Academics</span>
                <svg
                  className={`ml-3 h-5 w-5 transform ${expandedSections.academics ? 'rotate-90' : ''}`}
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
